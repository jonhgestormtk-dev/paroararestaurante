    ...
    <header className="fixed top-0 z-50 w-full h-20 md:h-24 bg-marrom-escuro text-areia-clara shadow-[0_4px_30px_rgba(0,0,0,0.3)] border-b border-marrom-madeira/40 transition-all duration-500 backdrop-blur-sm bg-opacity-95 flex items-center">
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 md:gap-6">
          <div className="relative cursor-pointer group p-2 hover:bg-white/5 rounded-full transition-colors" onClick={() => {
            const tray = document.querySelector('[role="dialog"]');
            if (!tray) {
              // This is a fallback if the CartTray isn't easily triggerable this way
              // In this app structure, the CartTray is always present if items exist
            }
          }}>
