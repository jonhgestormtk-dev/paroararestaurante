...
export function FloatingWhatsAppButton() {
  ...
  return (
    <button
      onClick={handleClick}
      className={cn(
        "fixed right-4 md:right-8 z-40 bg-[#25D366] text-white p-3.5 md:p-5 rounded-full shadow-[0_10px_40px_rgba(37,211,102,0.4)] transition-all duration-500 hover:scale-110 active:scale-95 flex items-center justify-center border-2 border-white/20 group",
        totalItems > 0 
    ...
    >
      <svg 
        viewBox="0 0 24 24" 
        className="w-6 h-6 md:w-8 md:h-8 group-hover:rotate-12 transition-transform fill-current"
